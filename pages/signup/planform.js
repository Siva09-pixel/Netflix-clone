...
const planform = () => {
 ...
 // console.log(user)
  ...
  const handleSubmit = async () => {
    await addDoc(colref, {
      email: user.email,
      plan: plan1 ? 1 : plan2 ? 2 : plan3 ? 3 : plan4 ? 4 : 0,
    })
      .then((res) => {
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.s11}>
          <svg
            ...
            className={`h-6 w-6 ${
              plan1 == true ? styles.svgred : styles.svggrey
            }`}
            fill="none"
            viewBox="0 0 24 24"
            stroke="currentColor"
        ...
        <div className={styles.s2}>
          <div className={styles.s21}>
            ...
            <p
              className={
                plan1 == true
                  ? `${styles.redbox} ${styles.boxactive}`
                  : styles.redbox
              }
              onClick={handlePlan1}
            >
            ...
            <div className={styles.right1}>
              <p className={styles.cnormal2}>
                <div className={styles.device} onClick={handlePlan1}>
                  ...
                  <p className={plan1 == true ? styles.svgred : styles.svggrey}>
                    Phone
                  </p>
                </div>
                ...
                <div className={styles.device} onClick={handlePlan2}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-6 w-6 ${
                      plan2 == true ? styles.svgred : styles.svggrey
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  ...
                  <p className={plan2 == true ? styles.svgred : styles.svggrey}>
                    Phone
                  </p>
                </div>
                <div className={styles.device} onClick={handlePlan3}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-6 w-6 ${
                      plan3 == true ? styles.svgred : styles.svggrey
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  ...
                  <p className={plan3 == true ? styles.svgred : styles.svggrey}>
                    Phone
                  </p>
                </div>
                <div className={styles.device} onClick={handlePlan4}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-6 w-6 ${
                      plan4 == true ? styles.svgred : styles.svggrey
                    }`}
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  ...
                  <p className={plan4 == true ? styles.svgred : styles.svggrey}>
                    Phone
                  </p>
                </div>
              </p>
              ...
              <p className={styles.cnormal2}>
                <div className={styles.device} onClick={handlePlan1}></div>
                <div className={styles.device} onClick={handlePlan2}>
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className={`h-6 w-6 ${
