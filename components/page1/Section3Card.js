      ...
      <div className={styles.card}>
        <div className={styles.top}>
          ...
          <button
            ...
            className={one == true ? styles.btn_active : styles.btn}
          >
            +
          </button>
        </div>
      ...
      <div className={styles.card}>
        <div className={styles.top}>
          ...
          <button
            ...
            className={four == true ? styles.btn_active : styles.btn}
          >
            +
          </button>
        </div>
      ...
      <div className={styles.card}>
        <div className={styles.top}>
          ...
          <button
            ...
            className={five == true ? styles.btn_active : styles.btn}
          >
            +
          </button>
        </div>
      ...
      <div className={styles.card}>
        <div className={styles.top}>
          ...
          <button
            ...
            className={six == true ? styles.btn_active : styles.btn}
          >
            +
          </button>
        </div>
